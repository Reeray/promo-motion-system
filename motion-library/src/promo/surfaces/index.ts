...
import {
  BlogBurstSurface,
  BlogEditorBrowserSurface,
  BlogPreviewZoomSurface,
  BlogPreviewResultSurface,
  BlogTeamSurface,
  BlogPublishFullSurface,
  BlogPublishZoomedSurface,
...
export const SURFACES: Record<string, Surface> = {
  ...
  'hf-blog-editor-browser': {
    id: 'hf-blog-editor-browser',
    label: 'HF · Blog editor — the editor at rest',
    frames: WRITEA_FRAMES,
    Comp: BlogEditorBrowserSurface,
  },
  'hf-blog-preview-zoom': {
    id: 'hf-blog-preview-zoom',
    label: 'HF · Blog editor — macro crop at Preview (click)',
    frames: WRITEB_FRAMES,
    bleed: true,
    cues: WRITEB_CUES,
    Comp: BlogPreviewZoomSurface,
  },
  'hf-blog-preview-result': {
    id: 'hf-blog-preview-result',
    label: 'HF · Blog editor — the article, rendered',
    frames: WRITEC_FRAMES,
    Comp: BlogPreviewResultSurface,
  },
  'hf-blog-team': {
    id: 'hf-blog-team',
  ...
  'hf-blog-publish-full': {
    ...
    label: 'HF · Blog editor — the whole editor at rest',
    frames: PUBA_FRAMES,
    Comp: BlogPublishFullSurface,
  },
  'hf-blog-publish-zoomed': {
    id: 'hf-blog-publish-zoomed',
    label: 'HF · Blog editor — macro crop at Publish (click)',
    frames: PUBB_FRAMES,
    bleed: true,
    cues: PUBB_CUES,
    Comp: BlogPublishZoomedSurface,
  },
